...
class LinearityTesting(ScriptedLoadableModule):
  def __init__(self, parent):
    ScriptedLoadableModule.__init__(self, parent)
    self.parent.title = "LinearityTesting" # TODO make this more human readable by adding spaces
...
#
# LinearityTestingWidget
#

class LinearityTestingWidget(ScriptedLoadableModuleWidget):
  def setup(self):
  ...
  def onStart(self):
    self.logic = LinearityTestingLogic()
...
#
# LinearityTestingLogic
#

class LinearityTestingLogic(ScriptedLoadableModuleLogic):
...
class LinearityTestingTest(ScriptedLoadableModuleTest):
  def setUp(self):
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_LinearityTesting1()

  def test_LinearityTesting1(self):
